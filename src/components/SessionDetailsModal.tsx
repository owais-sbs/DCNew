        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="flex flex-col">
            <h4 className="font-bold text-slate-700 mb-2 text-[10px] uppercase tracking-widest flex justify-between">
              ...
              <span className="text-slate-400 font-normal">Count: {filteredAllStudents.length}</span>
            </h4>
            ...
            <div className="mb-2 relative">
              <input
                ...
                className="w-full px-8 py-2 border border-gray-300 text-xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition-all"
              />
              <svg 
