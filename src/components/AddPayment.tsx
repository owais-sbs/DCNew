...
import { Search, X, Plus, ThumbsUp, ChevronDown, FileText } from "lucide-react"
  ...
  return (
    <div className="pl-[72px]">
      <div className="px-6 py-6">
        {/* Header */}
        <div className="text-2xl font-semibold text-gray-800 mb-6">New payment</div>
        ...
        <div className="grid grid-cols-[1fr_400px] gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* New receipt */}
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">New receipt</h3>
                ...
                <div className="bg-white rounded-xl p-6 w-[600px] max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <h4 className="font-medium text-gray-800 mb-3 mt-6">Credit</h4>
                      <div className="space-y-2">
                        <label className="flex items-center gap-2">
                          <input type="radio" name="creditType" className="text-indigo-600" />
                          <span className="text-sm text-gray-700">Add a credit</span>
                        </label>
                      </div>
                    </div>
